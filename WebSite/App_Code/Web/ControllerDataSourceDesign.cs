...
namespace MyFightTracker.Web.Design
{
    ...
    public class ControllerDataSourceDesignView : DesignerDataSourceView
    {
        ...
        public override IDataSourceViewSchema Schema
        {
            get
            {
                ...
                Stream res = GetType().Assembly.GetManifestResourceStream(String.Format("MyFightTracker.Controllers.{0}.xml", DataController));
                if (res == null)
                	res = GetType().Assembly.GetManifestResourceStream(String.Format("MyFightTracker.{0}.xml", DataController));
                if (res != null)
