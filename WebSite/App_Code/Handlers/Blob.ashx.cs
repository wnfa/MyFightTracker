...
namespace MyFightTracker.Handlers
{
	public partial class BlobFactory
    {
        ...
        static BlobFactory()
        {
            ...
            RegisterHandler("site_contentdata", "`myfighttracker`.`site_content`", "`data`", new string[] {
                        "`site_content_id`"}, "Myfighttracker Site Content Data", "myfighttracker_site_content", "data");
            RegisterHandler("site_contentData", "`myfighttracker`.`site_content`", "`Data`", new string[] {
                        "`SiteContentID`"}, "Myfighttrackersite Content Data", "MyfighttrackersiteContent", "Data");
        }
    }
...
function UploadSuccess(key, message) { 
    ...
    public class BlobAdapter
    {
        ...
        public static string ValidationKey
        {
            get
            {
                return "60A7B44E2E5DEE2A746D215785D43CBD838CCEC30D39AA0E9689AD562216B1033F28513F42AFADD3D" +
                    "5B76126C1D38A4D49F94334E40E2D07F35A0408B38E03F1";
            }
        }
