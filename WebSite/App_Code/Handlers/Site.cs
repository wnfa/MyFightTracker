...
namespace MyFightTracker.Handlers
{
    ...
    public class SiteBase : MyFightTracker.Web.PageBase
    {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (_isTouchUI)
            {
                if (_pageFooterContent != null)
                	_pageFooterContent.Text = "<footer style=\"display:none\"><small>&copy; 2016 MyFightTracker. ^Copyright^All ri" +
                        "ghts reserved.^Copyright^</small></footer>";
            }
            else
        ...
        protected virtual void InitializeSiteMaster()
        {
            ...
            string themePath = Server.MapPath("~/App_Themes/MyFightTracker");
            if (Directory.Exists(themePath))
            	foreach (string stylesheetFileName in Directory.GetFiles(themePath, "*.css"))
                {
                    ...
                    if (!(fileName.Equals("_Theme_Aquarium.css")))
                    {
                        ...
                        link.Href = ("~/App_Themes/MyFightTracker/" + fileName);
